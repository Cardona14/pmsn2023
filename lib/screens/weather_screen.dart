...
import 'package:pmsn2023/network/api_weather.dart';
import 'package:pmsn2023/screens/map_screen.dart';
...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  Future<void> getTemp() async {
    ...
    setState(() {
      ...
      minTemp = double.parse(resC["main"]["temp_min"].toString()).toInt().toString();
      maxTemp = double.parse(resC["main"]["temp_max"].toString()).toInt().toString();
      weatherState = resC["weather"][0]["description"].toString();
      feels = double.parse(resC["main"]["feels_like"].toString()).toInt().toString();
      ...
      for (var element in list) {
        ...
        if (today != date) {
          ...
          if (!nextDays.contains(dayOfWeek)) {
            nextTemps.add([
              double.parse(element["main"]["temp_min"].toString()).toInt().toString(),
              double.parse(element["main"]["temp_max"].toString()).toInt().toString(),
