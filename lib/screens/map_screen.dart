...
class _MapScreenState extends State<MapScreen> {
            ...
            TextButton(
              onPressed: () async {
                if (markerName.text != "") {
                  ...
                  var temp = double.parse(res!["main"]["temp"].toString()).toInt().toString();
                  _markers.add(
                    Marker(
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text("No puedes dejar el nombre del marcador en blanco"),
                        actions: [
                          TextButton(
                            onPressed: () {
                              Navigator.pop(context);
  ...
  Future getLocationsInMap() async {
    ...
    for (var location in res) {
      ...
      var temp = double.parse(resApi!["main"]["temp"].toString()).toInt().toString();
      aux.add(Marker(
